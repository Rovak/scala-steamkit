package rovak.steamkit.types.steamid;

import java.util.HashMap;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

import rovak.steamkit.steam.language.EAccountType;
import rovak.steamkit.steam.language.EUniverse;

public class SteamID {
	BitVector64 steamid = new BitVector64(1);

	static Pattern SteamIDRegex = Pattern.compile("STEAM_(?<universe>[0-5]):(?<authserver>[0-1]):(?<accountid>\\d+)", Pattern.CASE_INSENSITIVE);

	/**
	 * The account instance value when representing all instanced {@link rovak.steamkit.types.steamid.SteamID}
	 */
	public static final int AllInstances = 0;
	/**
	 * The account instance value for a desktop {@link rovak.steamkit.types.steamid.SteamID}.
	 */
	public static final int DesktopInstance = 1;
	/**
	 * The account instance value for a console {@link rovak.steamkit.types.steamid.SteamID}.
	 */
	public static final int ConsoleInstance = 2;
	/**
	 * The account instance for a mobile or web based {@link rovak.steamkit.types.steamid.SteamID}.
	 */
	...
	/**
	 * Masking value used for packing chat instance flags into a {@link rovak.steamkit.types.steamid.SteamID}.
	 */
	public static final int AccountInstanceMask = 0x000FFFFF;

	/**
	 * Represents various flags a chat {@link rovak.steamkit.types.steamid.SteamID} may have, packed into its instance.
	 */
	public enum ChatInstanceFlags {
		/**
		 * This flag is set for clan based chat {@link rovak.steamkit.types.steamid.SteamID}s.
		 */
		Clan(SteamID.AccountInstanceMask + 1 >> 1),
		/**
		 * This flag is set for lobby based chat {@link rovak.steamkit.types.steamid.SteamID}s.
		 */
		Lobby(SteamID.AccountInstanceMask + 1 >> 2),
		/**
		 * This flag is set for matchmaking lobby based chat {@link rovak.steamkit.types.steamid.SteamID}s.
		 */
	...
	/**
	 * Initializes a new instance of the {@link rovak.steamkit.types.steamid.SteamID} class.
	 */
	public SteamID() {
		this(0);
	}
	...
	/**
	 * Initializes a new instance of the {@link rovak.steamkit.types.steamid.SteamID} class from a rendered form.
	...
	/**
	 * Initializes a new instance of the {@link rovak.steamkit.types.steamid.SteamID} class from a rendered form and universe.
	 * @param steamId	A "STEAM_" rendered form of the SteamID.
