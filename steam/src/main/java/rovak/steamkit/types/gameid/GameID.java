package rovak.steamkit.types.gameid;

import rovak.steamkit.types.steamid.BitVector64;
...
public class GameID {
	...
	/**
	 * Initializes a new instance of the {@link rovak.steamkit.types.gameid.GameID} class.
	 */
	public GameID() {
		this(0);
	}
	...
	/**
	 * Performs an implicit conversion from {@link rovak.steamkit.types.gameid.GameID} to {@link String}.
	 */
	@Override
